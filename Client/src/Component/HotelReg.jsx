        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <div className='w-full mt-4'>
            <label htmlFor="contact" className='font-medium text-gray-500'>
             ...
             <input id='contact' onChange={(e)=> setContact(e.target.value)} type='text' placeholder='Type here' value={contact} className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
          </div>
          ...
          <div className='w-full mt-4'>
            <label htmlFor="address" className='font-medium text-gray-500'>
             ...
             <input onChange={(e)=> setAddress(e.target.value)} id='address' type='text' placeholder='Type here' value={address} className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
          </div>
          ...
          <button type='submit' className='bg-indigo-500 hover:bg-indigo-600 transition-all text-white px-6 py-2 rounded cursor-pointer mt-6'>Register</button>
